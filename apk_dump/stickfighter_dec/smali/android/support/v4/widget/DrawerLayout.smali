...
.field private final k:Landroid/support/v4/widget/bq;

.field private final l:Landroid/support/v4/widget/bq;

.field private final m:Landroid/support/v4/widget/z;

.field private final n:Landroid/support/v4/widget/z;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/t;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/cb;->c(Landroid/view/View;I)V
...
.method private e()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, Landroid/support/v4/view/cb;->h(Landroid/view/View;)I
...
.method private h()Z
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/DrawerLayout;->i()Landroid/view/View;
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bq;

    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/bq;->e()V
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bq;
...
.method a(IILandroid/view/View;)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bq;

    invoke-virtual {v2}, Landroid/support/v4/widget/bq;->a()I

    move-result v2

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bq;

    invoke-virtual {v3}, Landroid/support/v4/widget/bq;->a()I
    ...
    iget v2, v0, Landroid/support/v4/widget/x;->b:F
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->v:Landroid/support/v4/widget/w;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->v:Landroid/support/v4/widget/w;

    invoke-interface {v0, v1}, Landroid/support/v4/widget/w;->onDrawerStateChanged(I)V
    ...
    :cond_6
    iget v0, v0, Landroid/support/v4/widget/x;->b:F
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/widget/w;->onDrawerSlide(Landroid/view/View;F)V
...
.method a(Z)V
    ...
    iget-boolean v6, v0, Landroid/support/v4/widget/x;->c:Z
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bq;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/bq;->a(Landroid/view/View;II)Z
    ...
    :goto_2
    iput-boolean v3, v0, Landroid/support/v4/widget/x;->c:Z

    goto :goto_1

    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bq;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/bq;->a(Landroid/view/View;II)Z
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/z;

    invoke-virtual {v0}, Landroid/support/v4/widget/z;->a()V

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/z;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/cb;->c(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/support/v4/widget/s;

    invoke-static {p1, v0}, Landroid/support/v4/view/cb;->a(Landroid/view/View;Landroid/support/v4/view/a;)V
...
.method b(Landroid/view/View;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/widget/x;->d:Z

    if-eqz v1, :cond_1

    iput-boolean v2, v0, Landroid/support/v4/widget/x;->d:Z
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/w;->onDrawerClosed(Landroid/view/View;)V
...
.method b(Landroid/view/View;F)V
    ...
    iget v1, v0, Landroid/support/v4/widget/x;->b:F
    ...
    :cond_0
    iput p2, v0, Landroid/support/v4/widget/x;->b:F
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/w;->onDrawerOpened(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bq;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bq;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/bq;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bq;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/bq;->b()I
...
.method e(Landroid/view/View;)I
    ...
    iget v0, v0, Landroid/support/v4/widget/x;->a:I
...
.method g(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/view/cb;->h(Landroid/view/View;)I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v4/widget/x;-><init>(II)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/x;-><init>(Landroid/support/v4/widget/x;)V
...
.method public h(Landroid/view/View;)V
    ...
    iput v1, v0, Landroid/support/v4/widget/x;->b:F
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/bq;->a(Landroid/view/View;II)Z
...
.method public i(Landroid/view/View;)V
    ...
    iput-boolean v1, v0, Landroid/support/v4/widget/x;->d:Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/t;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->B:Ljava/lang/Object;

    invoke-interface {v0, v1}, Landroid/support/v4/widget/t;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bq;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/bq;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bq;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/bq;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bq;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/bq;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bq;->c(I)Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {p2}, Landroid/support/v4/view/aa;->b(Landroid/view/KeyEvent;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget v1, v0, Landroid/support/v4/widget/x;->leftMargin:I

    iget v2, v0, Landroid/support/v4/widget/x;->topMargin:I

    iget v3, v0, Landroid/support/v4/widget/x;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v4/widget/x;->topMargin:I
    ...
    iget v3, v0, Landroid/support/v4/widget/x;->b:F
    ...
    :goto_3
    iget v4, v0, Landroid/support/v4/widget/x;->a:I

    and-int/lit8 v4, v4, 0x70

    sparse-switch v4, :sswitch_data_0

    iget v4, v0, Landroid/support/v4/widget/x;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Landroid/support/v4/widget/x;->topMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/x;->bottomMargin:I
    ...
    iget v11, v0, Landroid/support/v4/widget/x;->bottomMargin:I
    ...
    iget v12, v0, Landroid/support/v4/widget/x;->topMargin:I
    ...
    iget v13, v0, Landroid/support/v4/widget/x;->bottomMargin:I

    sub-int v13, v11, v13

    if-le v12, v13, :cond_6

    iget v4, v0, Landroid/support/v4/widget/x;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/cb;->u(Landroid/view/View;)Z
    ...
    iget v9, v0, Landroid/support/v4/widget/x;->a:I

    invoke-static {v9, v6}, Landroid/support/v4/view/v;->a(II)I

    move-result v9

    invoke-static {v8}, Landroid/support/v4/view/cb;->u(Landroid/view/View;)Z

    move-result v10

    if-eqz v10, :cond_a

    sget-object v10, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/t;

    iget-object v11, p0, Landroid/support/v4/widget/DrawerLayout;->B:Ljava/lang/Object;

    invoke-interface {v10, v8, v11, v9}, Landroid/support/v4/widget/t;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget v9, v0, Landroid/support/v4/widget/x;->leftMargin:I

    sub-int v9, v2, v9

    iget v10, v0, Landroid/support/v4/widget/x;->rightMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/x;->topMargin:I

    sub-int v10, v1, v10

    iget v0, v0, Landroid/support/v4/widget/x;->bottomMargin:I
    ...
    invoke-interface {v10, v0, v11, v9}, Landroid/support/v4/widget/t;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    invoke-static {v8}, Landroid/support/v4/view/cb;->r(Landroid/view/View;)F
    ...
    invoke-static {v8, v9}, Landroid/support/v4/view/cb;->d(Landroid/view/View;F)V
    ...
    iget v10, v0, Landroid/support/v4/widget/x;->leftMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/x;->width:I
    ...
    iget v0, v0, Landroid/support/v4/widget/x;->height:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/bq;->b(Landroid/view/MotionEvent;)V
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bq;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/bq;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/bq;->d()I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/cb;->d(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroid/support/v4/widget/w;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->v:Landroid/support/v4/widget/w;
