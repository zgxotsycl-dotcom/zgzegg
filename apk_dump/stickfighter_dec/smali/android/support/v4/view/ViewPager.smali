...
.field private static final ah:Landroid/support/v4/view/du;
...
.field private final f:Landroid/support/v4/view/dm;

.field private final g:Landroid/graphics/Rect;

.field private h:Landroid/support/v4/view/bt;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->ah:Landroid/support/v4/view/du;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Landroid/support/v4/view/dm;
...
.method private a(IFII)I
    ...
    check-cast v1, Landroid/support/v4/view/dm;

    iget v0, v0, Landroid/support/v4/view/dm;->b:I

    iget v1, v1, Landroid/support/v4/view/dm;->b:I
...
.method static synthetic a(Landroid/support/v4/view/ViewPager;)Landroid/support/v4/view/bt;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;
...
.method private a(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/dm;

    move-result-object v3

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/widget/Scroller;

    iget v3, v3, Landroid/support/v4/view/dm;->e:F
    ...
    iget v0, v0, Landroid/support/v4/view/dm;->e:F
...
.method private a(IZIZ)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/dm;
...
.method private a(Landroid/support/v4/view/dm;ILandroid/support/v4/view/dm;)V
    .locals 11
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/bt;->b()I
    ...
    iget v0, p3, Landroid/support/v4/view/dm;->b:I

    iget v1, p1, Landroid/support/v4/view/dm;->b:I

    if-ge v0, v1, :cond_3

    iget v1, p3, Landroid/support/v4/view/dm;->e:F

    iget v2, p3, Landroid/support/v4/view/dm;->d:F
    ...
    :goto_1
    iget v0, p1, Landroid/support/v4/view/dm;->b:I
    ...
    :goto_2
    iget v5, v0, Landroid/support/v4/view/dm;->b:I
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    invoke-virtual {v5, v2}, Landroid/support/v4/view/bt;->d(I)F
    ...
    :cond_2
    iput v3, v0, Landroid/support/v4/view/dm;->e:F

    iget v0, v0, Landroid/support/v4/view/dm;->d:F
    ...
    iget v3, p3, Landroid/support/v4/view/dm;->e:F
    ...
    :cond_5
    iget v5, v0, Landroid/support/v4/view/dm;->d:F
    ...
    iget v2, p1, Landroid/support/v4/view/dm;->e:F
    ...
    iget v0, p1, Landroid/support/v4/view/dm;->e:F
    ...
    iget v3, p1, Landroid/support/v4/view/dm;->d:F
    ...
    :goto_a
    iget v2, v0, Landroid/support/v4/view/dm;->b:I

    if-le v1, v2, :cond_9

    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    add-int/lit8 v2, v1, -0x1

    invoke-virtual {v9, v1}, Landroid/support/v4/view/bt;->d(I)F
    ...
    :cond_9
    iget v2, v0, Landroid/support/v4/view/dm;->d:F

    add-float/2addr v2, v6

    sub-float v2, v3, v2

    iput v2, v0, Landroid/support/v4/view/dm;->e:F
    ...
    iget v1, p1, Landroid/support/v4/view/dm;->d:F
...
.method private a(Z)V
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/dm;->c:Z

    if-eqz v5, :cond_2

    iput-boolean v2, v0, Landroid/support/v4/view/dm;->c:Z
...
.method private b(F)Z
    ...
    iget v8, v0, Landroid/support/v4/view/dm;->b:I
    ...
    :goto_0
    iget v8, v1, Landroid/support/v4/view/dm;->b:I

    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    invoke-virtual {v9}, Landroid/support/v4/view/bt;->b()I
    ...
    iget v1, v1, Landroid/support/v4/view/dm;->e:F
...
.method private d(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->j()Landroid/support/v4/view/dm;
    ...
    iget v5, v1, Landroid/support/v4/view/dm;->b:I
    ...
    iget v6, v1, Landroid/support/v4/view/dm;->e:F

    sub-float/2addr v2, v6

    iget v1, v1, Landroid/support/v4/view/dm;->d:F
...
.method private g()V
    ...
    iget-boolean v0, v0, Landroid/support/v4/view/dn;->a:Z
...
.method private h()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->ah:Landroid/support/v4/view/du;
...
.method private j()Landroid/support/v4/view/dm;
    .locals 13
    ...
    iget v10, v0, Landroid/support/v4/view/dm;->b:I

    add-int/lit8 v11, v8, 0x1

    if-eq v10, v11, :cond_6

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Landroid/support/v4/view/dm;

    add-float/2addr v6, v7

    add-float/2addr v6, v1

    iput v6, v0, Landroid/support/v4/view/dm;->e:F

    add-int/lit8 v6, v8, 0x1

    iput v6, v0, Landroid/support/v4/view/dm;->b:I

    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    iget v7, v0, Landroid/support/v4/view/dm;->b:I

    invoke-virtual {v6, v7}, Landroid/support/v4/view/bt;->d(I)F

    move-result v6

    iput v6, v0, Landroid/support/v4/view/dm;->d:F
    ...
    :goto_3
    iget v6, v2, Landroid/support/v4/view/dm;->e:F

    iget v7, v2, Landroid/support/v4/view/dm;->d:F
    ...
    :cond_5
    iget v5, v2, Landroid/support/v4/view/dm;->b:I

    iget v4, v2, Landroid/support/v4/view/dm;->d:F
...
.method a(II)Landroid/support/v4/view/dm;
    .locals 2
    ...
    iput p1, v0, Landroid/support/v4/view/dm;->b:I

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    invoke-virtual {v1, p0, p1}, Landroid/support/v4/view/bt;->a(Landroid/view/ViewGroup;I)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v4/view/dm;->a:Ljava/lang/Object;

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    invoke-virtual {v1, p1}, Landroid/support/v4/view/bt;->d(I)F

    move-result v1

    iput v1, v0, Landroid/support/v4/view/dm;->d:F
...
.method a(Landroid/view/View;)Landroid/support/v4/view/dm;
    .locals 4
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    iget-object v3, v0, Landroid/support/v4/view/dm;->a:Ljava/lang/Object;

    invoke-virtual {v2, p1, v3}, Landroid/support/v4/view/bt;->a(Landroid/view/View;Ljava/lang/Object;)Z
...
.method a()V
    ...
    invoke-static {v1}, Landroid/support/v4/view/da;->a(Landroid/view/ViewConfiguration;)I
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/ab;

    new-instance v1, Landroid/support/v4/widget/ab;

    invoke-direct {v1, v0}, Landroid/support/v4/widget/ab;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/ab;
    ...
    invoke-static {p0, v4}, Landroid/support/v4/view/cb;->c(Landroid/view/View;I)V
...
.method a(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/dm;
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/view/bt;->a(Landroid/view/ViewGroup;)V
    ...
    iget-object v5, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    invoke-virtual {v5}, Landroid/support/v4/view/bt;->b()I
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;
    ...
    check-cast v2, Landroid/support/v4/view/dm;

    iget v7, v2, Landroid/support/v4/view/dm;->b:I
    ...
    invoke-virtual {v0, v2, v5}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/dm;
    ...
    :cond_5
    iget v6, v10, Landroid/support/v4/view/dm;->d:F
    ...
    invoke-direct {v0, v10, v8, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/dm;ILandroid/support/v4/view/dm;)V
    ...
    iget-object v2, v10, Landroid/support/v4/view/dm;->a:Ljava/lang/Object;

    :goto_d
    move-object/from16 v0, p0

    invoke-virtual {v4, v0, v5, v2}, Landroid/support/v4/view/bt;->b(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/view/bt;->b(Landroid/view/ViewGroup;)V
    ...
    iput v4, v2, Landroid/support/v4/view/dn;->f:I

    iget-boolean v7, v2, Landroid/support/v4/view/dn;->a:Z

    if-nez v7, :cond_8

    iget v7, v2, Landroid/support/v4/view/dn;->c:F
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dm;

    move-result-object v6

    if-eqz v6, :cond_8

    iget v7, v6, Landroid/support/v4/view/dm;->d:F

    iput v7, v2, Landroid/support/v4/view/dn;->c:F

    iget v6, v6, Landroid/support/v4/view/dm;->b:I

    iput v6, v2, Landroid/support/v4/view/dn;->e:I
    ...
    iget v7, v10, Landroid/support/v4/view/dm;->d:F
    ...
    :cond_c
    iget v15, v2, Landroid/support/v4/view/dm;->b:I

    if-ne v9, v15, :cond_d

    iget-boolean v15, v2, Landroid/support/v4/view/dm;->c:Z
    ...
    iget-object v15, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    iget-object v2, v2, Landroid/support/v4/view/dm;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v15, v0, v9, v2}, Landroid/support/v4/view/bt;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget v2, v2, Landroid/support/v4/view/dm;->d:F
    ...
    invoke-virtual {v0, v9, v2}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/dm;
    ...
    :cond_15
    iget v11, v2, Landroid/support/v4/view/dm;->b:I

    if-ne v9, v11, :cond_20

    iget-boolean v11, v2, Landroid/support/v4/view/dm;->c:Z
    ...
    iget-object v11, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    iget-object v2, v2, Landroid/support/v4/view/dm;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v11, v0, v9, v2}, Landroid/support/v4/view/bt;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v9, v7}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/dm;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Landroid/support/v4/view/dm;
    ...
    iget v2, v2, Landroid/support/v4/view/dm;->b:I
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dm;

    move-result-object v5

    if-eqz v5, :cond_1e

    iget v5, v5, Landroid/support/v4/view/dm;->b:I
...
.method protected a(IFI)V
    ...
    iget-boolean v9, v0, Landroid/support/v4/view/dn;->a:Z
...
.method a(III)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v4/view/bt;->d(I)F
...
.method a(IZZI)V
    ...
    iput-boolean v3, v0, Landroid/support/v4/view/dm;->c:Z
...
.method public a(Landroid/view/KeyEvent;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/view/aa;->a(Landroid/view/KeyEvent;)Z
    ...
    :cond_1
    invoke-static {p1, v3}, Landroid/support/v4/view/aa;->a(Landroid/view/KeyEvent;I)Z
...
.method protected a(Landroid/view/View;ZIII)Z
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/cb;->a(Landroid/view/View;I)Z
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dm;

    move-result-object v4

    if-eqz v4, :cond_0

    iget v4, v4, Landroid/support/v4/view/dm;->b:I
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dm;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-boolean v2, v0, Landroid/support/v4/view/dn;->a:Z

    instance-of v3, p1, Landroid/support/v4/view/dl;

    or-int/2addr v2, v3

    iput-boolean v2, v0, Landroid/support/v4/view/dn;->a:Z
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/dn;->d:Z
...
.method b(I)Landroid/support/v4/view/dm;
    .locals 3
...
.method b(Landroid/view/View;)Landroid/support/v4/view/dm;
    .locals 2
    ...
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dm;
...
.method b()V
    ...
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    iget-object v9, v0, Landroid/support/v4/view/dm;->a:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Landroid/support/v4/view/bt;->a(Ljava/lang/Object;)I
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    invoke-virtual {v4, p0}, Landroid/support/v4/view/bt;->a(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v6, p0, v7, v9}, Landroid/support/v4/view/bt;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    :cond_3
    iget v9, v0, Landroid/support/v4/view/dm;->b:I

    if-eq v9, v7, :cond_a

    iget v6, v0, Landroid/support/v4/view/dm;->b:I
    ...
    :cond_4
    iput v7, v0, Landroid/support/v4/view/dm;->b:I
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/view/bt;->b(Landroid/view/ViewGroup;)V
    ...
    iget-boolean v6, v0, Landroid/support/v4/view/dn;->a:Z

    if-nez v6, :cond_7

    const/4 v6, 0x0

    iput v6, v0, Landroid/support/v4/view/dn;->c:F
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    instance-of v0, p1, Landroid/support/v4/view/dn;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/view/bt;->b()I
...
.method e()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/bt;->b()I
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/view/dn;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public getAdapter()Landroid/support/v4/view/bt;
    .locals 1
...
.method protected getChildDrawingOrder(II)I
    ...
    iget v0, v0, Landroid/support/v4/view/dn;->f:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;
    ...
    iget v4, v1, Landroid/support/v4/view/dm;->e:F
    ...
    iget v3, v1, Landroid/support/v4/view/dm;->b:I
    ...
    iget v10, v2, Landroid/support/v4/view/dm;->b:I
    ...
    iget v3, v1, Landroid/support/v4/view/dm;->e:F

    iget v4, v1, Landroid/support/v4/view/dm;->d:F
    ...
    iget v11, v1, Landroid/support/v4/view/dm;->d:F
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    invoke-virtual {v3, v5}, Landroid/support/v4/view/bt;->d(I)F
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v7, v1, Landroid/support/v4/view/dn;->a:Z

    if-eqz v7, :cond_5

    iget v7, v1, Landroid/support/v4/view/dn;->b:I
    ...
    iget-boolean v10, v1, Landroid/support/v4/view/dn;->a:Z

    if-nez v10, :cond_2

    move-object/from16 v0, p0

    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dm;
    ...
    iget v10, v10, Landroid/support/v4/view/dm;->e:F
    ...
    iget-boolean v12, v1, Landroid/support/v4/view/dn;->d:Z

    if-eqz v12, :cond_1

    const/4 v12, 0x0

    iput-boolean v12, v1, Landroid/support/v4/view/dn;->d:Z

    int-to-float v12, v7

    iget v1, v1, Landroid/support/v4/view/dn;->c:F
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/view/dn;->a:Z

    if-eqz v1, :cond_3

    iget v1, v0, Landroid/support/v4/view/dn;->b:I
    ...
    :cond_2
    :goto_3
    iget v4, v0, Landroid/support/v4/view/dn;->width:I
    ...
    iget v2, v0, Landroid/support/v4/view/dn;->width:I
    ...
    :goto_4
    iget v11, v0, Landroid/support/v4/view/dn;->height:I
    ...
    iget v0, v0, Landroid/support/v4/view/dn;->height:I
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/dn;->a:Z
    ...
    iget v0, v0, Landroid/support/v4/view/dn;->c:F
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/dm;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/bt;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/bt;->a()Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, v2}, Landroid/support/v4/view/bw;->a(Landroid/view/VelocityTracker;I)F
    ...
    iget v5, v4, Landroid/support/v4/view/dm;->b:I
    ...
    iget v3, v4, Landroid/support/v4/view/dm;->e:F

    sub-float/2addr v2, v3

    iget v3, v4, Landroid/support/v4/view/dm;->d:F
...
.method public setAdapter(Landroid/support/v4/view/bt;)V
    .locals 7
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/bt;->b(Landroid/database/DataSetObserver;)V

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    invoke-virtual {v0, p0}, Landroid/support/v4/view/bt;->a(Landroid/view/ViewGroup;)V
    ...
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;

    iget v4, v0, Landroid/support/v4/view/dm;->b:I

    iget-object v0, v0, Landroid/support/v4/view/dm;->a:Ljava/lang/Object;

    invoke-virtual {v3, p0, v4, v0}, Landroid/support/v4/view/bt;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bt;
    ...
    invoke-direct {v1, p0, v5}, Landroid/support/v4/view/ds;-><init>(Landroid/support/v4/view/ViewPager;Landroid/support/v4/view/di;)V
    ...
    invoke-virtual {v1, v3}, Landroid/support/v4/view/bt;->a(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v3}, Landroid/support/v4/view/bt;->b()I
    ...
    invoke-virtual {v1, v3, v4}, Landroid/support/v4/view/bt;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    invoke-interface {v1, v0, p1}, Landroid/support/v4/view/dp;->a(Landroid/support/v4/view/bt;Landroid/support/v4/view/bt;)V
