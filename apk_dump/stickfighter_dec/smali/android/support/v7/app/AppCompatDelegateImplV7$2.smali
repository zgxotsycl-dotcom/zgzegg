...
.method public onApplyWindowInsets(Landroid/view/View;Landroid/support/v4/view/ew;)Landroid/support/v4/view/ew;
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/ew;->b()I
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/ew;->a()I

    move-result v0

    invoke-virtual {p2}, Landroid/support/v4/view/ew;->c()I

    move-result v2

    invoke-virtual {p2}, Landroid/support/v4/view/ew;->d()I

    move-result v3

    invoke-virtual {p2, v0, v1, v2, v3}, Landroid/support/v4/view/ew;->a(IIII)Landroid/support/v4/view/ew;

    move-result-object p2

    :cond_0
    invoke-static {p1, p2}, Landroid/support/v4/view/cb;->a(Landroid/view/View;Landroid/support/v4/view/ew;)Landroid/support/v4/view/ew;
