...
.method public static a(Landroid/app/Notification$Builder;Landroid/support/v4/app/cs;)Landroid/os/Bundle;
    .locals 3
    ...
    invoke-static {v2}, Landroid/support/v4/app/dm;->a([Landroid/support/v4/app/dk;)[Landroid/os/Bundle;
...
.method public static a(Landroid/app/Notification;ILandroid/support/v4/app/ct;Landroid/support/v4/app/dl;)Landroid/support/v4/app/cs;
    ...
    sget-object v7, Landroid/support/v4/app/cy;->d:Ljava/lang/Object;

    monitor-enter v7

    :try_start_0
    invoke-static {p0}, Landroid/support/v4/app/cy;->g(Landroid/app/Notification;)[Ljava/lang/Object;

    move-result-object v0

    aget-object v1, v0, p1

    invoke-static {p0}, Landroid/support/v4/app/cy;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    :goto_0
    sget-object v0, Landroid/support/v4/app/cy;->g:Ljava/lang/reflect/Field;

    invoke-virtual {v0, v1}, Ljava/lang/reflect/Field;->getInt(Ljava/lang/Object;)I

    move-result v2

    sget-object v0, Landroid/support/v4/app/cy;->h:Ljava/lang/reflect/Field;
    ...
    sget-object v0, Landroid/support/v4/app/cy;->i:Ljava/lang/reflect/Field;
    ...
    invoke-static/range {v0 .. v5}, Landroid/support/v4/app/cy;->a(Landroid/support/v4/app/ct;Landroid/support/v4/app/dl;ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;)Landroid/support/v4/app/cs;
    :try_end_0
    ...
    sput-boolean v0, Landroid/support/v4/app/cy;->j:Z
...
.method public static a(Landroid/support/v4/app/ct;Landroid/support/v4/app/dl;ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;)Landroid/support/v4/app/cs;
    .locals 6
    ...
    invoke-static {p5, v0}, Landroid/support/v4/app/z;->a(Landroid/os/Bundle;Ljava/lang/String;)[Landroid/os/Bundle;

    move-result-object v0

    invoke-static {v0, p1}, Landroid/support/v4/app/dm;->a([Landroid/os/Bundle;Landroid/support/v4/app/dl;)[Landroid/support/v4/app/dk;
...
.method public static a(Landroid/support/v4/app/bs;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Z)V
    .locals 2
...
.method public static a(Landroid/support/v4/app/bs;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/lang/CharSequence;)V
    .locals 2
...
.method public static a(Landroid/support/v4/app/bs;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/util/ArrayList;)V
    .locals 3
...
.method private static a()Z
    ...
    sget-boolean v2, Landroid/support/v4/app/cy;->j:Z
    ...
    :cond_0
    :try_start_0
    sget-object v2, Landroid/support/v4/app/cy;->f:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Landroid/support/v4/app/cy;->e:Ljava/lang/Class;

    sget-object v2, Landroid/support/v4/app/cy;->e:Ljava/lang/Class;
    ...
    sput-object v2, Landroid/support/v4/app/cy;->g:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Landroid/support/v4/app/cy;->h:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Landroid/support/v4/app/cy;->i:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Landroid/support/v4/app/cy;->f:Ljava/lang/reflect/Field;
...
.method public static b(Landroid/app/Notification;)I
    ...
    sget-object v1, Landroid/support/v4/app/cy;->d:Ljava/lang/Object;
...
.method private static g(Landroid/app/Notification;)[Ljava/lang/Object;
    ...
    sget-object v2, Landroid/support/v4/app/cy;->d:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    invoke-static {}, Landroid/support/v4/app/cy;->a()Z
    ...
    :cond_0
    :try_start_1
    sget-object v0, Landroid/support/v4/app/cy;->f:Ljava/lang/reflect/Field;
