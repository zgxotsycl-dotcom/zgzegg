...
# static fields
.field private static final v:Landroid/support/v4/widget/aj;

.field private static final w:[I


# instance fields
.field private A:Landroid/support/v4/widget/ak;

.field private a:J

.field private final b:Landroid/graphics/Rect;

.field private c:Landroid/support/v4/widget/ay;
...
.field private final x:Landroid/support/v4/view/br;

.field private final y:Landroid/support/v4/view/bp;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/NestedScrollView;->v:Landroid/support/v4/widget/aj;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/view/br;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/view/br;

    new-instance v0, Landroid/support/v4/view/bp;

    invoke-direct {v0, p0}, Landroid/support/v4/view/bp;-><init>(Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/view/bp;

    invoke-virtual {p0, v2}, Landroid/support/v4/widget/NestedScrollView;->setNestedScrollingEnabled(Z)V

    sget-object v0, Landroid/support/v4/widget/NestedScrollView;->v:Landroid/support/v4/widget/aj;
...
.method private a()V
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v4/widget/ay;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/ay;
...
.method public final a(II)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/ay;

    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->getScrollX()I

    move-result v3

    invoke-virtual {v2, v3, v1, v4, v0}, Landroid/support/v4/widget/ay;->a(IIII)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/ay;

    invoke-virtual {v0}, Landroid/support/v4/widget/ay;->a()Z
...
.method a(IIIIIIIIZ)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/ay;
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/support/v4/widget/ay;->a(IIIIII)Z
...
.method public computeScroll()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/ay;->g()Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/ay;->b()I

    move-result v1

    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/ay;

    invoke-virtual {v2}, Landroid/support/v4/widget/ay;->c()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/ay;->f()F
...
.method public d(I)V
    ...
    invoke-virtual/range {v0 .. v10}, Landroid/support/v4/widget/ay;->a(IIIIIIIIII)V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/view/bp;

    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/view/bp;->a(FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/view/bp;->a(FF)Z
...
.method public dispatchNestedPreScroll(II[I[I)Z
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/v4/view/bp;->a(II[I[I)Z
...
.method public dispatchNestedScroll(IIII[I)Z
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/view/bp;->a(IIII[I)Z
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/view/br;
...
.method public hasNestedScrollingParent()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/bp;->b()Z
...
.method public isNestedScrollingEnabled()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/bp;->a()Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/ay;->a()Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/widget/ay;->a(IIIIII)Z
...
.method protected onScrollChanged(IIII)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->A:Landroid/support/v4/widget/ak;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/v4/widget/ak;->onScrollChange(Landroid/support/v4/widget/NestedScrollView;IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/ay;

    invoke-virtual {v2}, Landroid/support/v4/widget/ay;->a()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/ay;->h()V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/cb;->a(Landroid/view/View;)I
    ...
    :cond_10
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/cb;->d(Landroid/view/View;)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/bw;->b(Landroid/view/VelocityTracker;I)F
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/support/v4/widget/ay;->a(IIIIII)Z
...
.method public setNestedScrollingEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/view/bp;->a(Z)V

    return-void
.end method

.method public setOnScrollChangeListener(Landroid/support/v4/widget/ak;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->A:Landroid/support/v4/widget/ak;
...
.method public startNestedScroll(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/view/bp;->a(I)Z
...
.method public stopNestedScroll()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/bp;->c()V
