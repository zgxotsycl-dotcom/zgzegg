...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/db;->c:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/app/db;->a:Landroid/app/Notification$Builder;

    new-instance v4, Landroid/os/Bundle;

    invoke-direct {v4}, Landroid/os/Bundle;-><init>()V

    iput-object v4, p0, Landroid/support/v4/app/db;->b:Landroid/os/Bundle;

    if-eqz p20, :cond_0

    iget-object v4, p0, Landroid/support/v4/app/db;->b:Landroid/os/Bundle;
    ...
    iget-object v5, p0, Landroid/support/v4/app/db;->b:Landroid/os/Bundle;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Landroid/support/v4/app/db;->a:Landroid/app/Notification$Builder;

    return-object v0
.end method

.method public a(Landroid/support/v4/app/cs;)V
    .locals 2

    iget-object v0, p0, Landroid/support/v4/app/db;->c:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/db;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/app/cy;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/cs;)Landroid/os/Bundle;
...
.method public b()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/app/db;->b:Landroid/os/Bundle;
