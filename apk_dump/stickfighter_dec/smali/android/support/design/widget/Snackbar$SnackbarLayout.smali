...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v1}, Landroid/support/v4/view/cb;->d(Landroid/view/View;F)V
    ...
    invoke-static {p0, v3}, Landroid/support/v4/view/cb;->d(Landroid/view/View;I)V
...
.method private static updateTopBottomPadding(Landroid/view/View;II)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/cb;->x(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Landroid/support/v4/view/cb;->k(Landroid/view/View;)I

    move-result v0

    invoke-static {p0}, Landroid/support/v4/view/cb;->l(Landroid/view/View;)I

    move-result v1

    invoke-static {p0, v0, p1, v1, p2}, Landroid/support/v4/view/cb;->a(Landroid/view/View;IIII)V
